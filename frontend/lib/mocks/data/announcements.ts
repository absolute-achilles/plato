...
export const announcements: Announcement[] = [
  {
    ...
    body:
      "Please review the mid-semester exam schedule on your dashboard. Good luck!",
    authorId: admin.id,
  ...
  },
  {
    ...
    body:
      "The quiz is now open and due this Friday. Don't forget to review module 1.",
    authorId: teacher.id,
    courseId: "course-1",
  ...
  },
  {
    ...
    body:
      "We invite all parents to join the online parent-teacher meeting on Tuesday.",
    authorId: teacher.id,
  ...
  },
  {
    ...
    body:
      "Plato will be under maintenance this Sunday from 02:00 to 04:00 WIB.",
    authorId: admin.id,
